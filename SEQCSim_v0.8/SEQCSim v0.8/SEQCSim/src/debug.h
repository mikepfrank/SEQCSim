...
// debug.h - Header file defining compile-time settings for debugging code.

#pragma once

namespace ns_debug {
	extern bool trace;	// Make this true to print detailed trace information to aid debugging.
}
